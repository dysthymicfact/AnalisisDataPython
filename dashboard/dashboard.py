...
with col[2]:
    ...
    st.metric('🎟️ Casual User', value=total_cas)
...
# Visualisasi 1: Tren peminjaman sepeda per bulan (registered vs casual)
...
# Visualisasi 2: Rata-rata Penyewaan Sepeda per Hari Berdasarkan Cuaca 
...
# Visualisasi 3: Rata-rata Jumlah Penyewaan Sepeda per Jam Berdasarkan Kondisi Cuaca
...
# Visualisasi 4, 5, dan 6 = Barplot 1, 2, dan 3
...
# Visualisasi 7: Distribusi Monetary per Jam
...
# Visualisasi 8: Distribusi Skor RFM untuk Registered User
